...
if __name__ == '__main__':
    ...
    parser.add_argument('--loss_weight', type=float, default=0.01, help='Loss weight based on instance loss ratio.')
    ...
    parser.add_argument('--num_fc', type=int, default=2, help='Number of Fully Connected Layers.')
